...
import 'package:buzz/screens/project_create_new/project_create_new_screen.dart';
  ...
  indexWiseNavigation({String? index}) {
    ...
    if (index == StringRes.dashboards) {
      Get.offAll(
          ...
          () => DashBoardScreen(child: HomeScreen(), screenName: 'DashBoards'));
    } else if (index == StringRes.general) {
      Get.offAll(
          transition: Transition.noTransition,
          () => DashBoardScreen(child: GeneralScreen(), screenName: 'General'));
      ...
      Get.offAll(
          transition: Transition.noTransition,
          () => DashBoardScreen(child: FileScreen(), screenName: 'E-Commerce'));
    } else if (index == StringRes.userProfile) {
      Get.offAll(
          transition: Transition.noTransition,
          () =>
              DashBoardScreen(child: UserProfileScreen(), screenName: 'Users'));
    } else if (index == StringRes.userEdit) {
      Get.offAll(
          transition: Transition.noTransition,
          () => DashBoardScreen(child: UserEditScreen(), screenName: 'Users'));
    } else if (index == StringRes.userCards) {
      Get.offAll(
          transition: Transition.noTransition,
          () => DashBoardScreen(child: UserCardScreen(), screenName: 'Users'));
    } else if (index == StringRes.level1) {
      Get.offAll(
          transition: Transition.noTransition,
          () => DashBoardScreen(child: Level11(), screenName: 'Level 1.1'));
      ...
      Get.offAll(
          transition: Transition.noTransition,
          () => DashBoardScreen(child:ProjectCreateNewScreen(), screenName: 'Project'));
    }
  }
                              ...
                              GestureDetector(
                                onTap: () {
                                  dashBoardController.selectedMainCategory =
                                      StringRes.buttons;
                                  setState(() {
                                    if (dashBoardController.buttons == true) {
                              ...
                              GestureDetector(
                                onTap: () {
                                  dashBoardController.selectedMainCategory =
                                      StringRes.menulevel;
                                  setState(() {
                                    if (dashBoardController.Menulevel == true) {
